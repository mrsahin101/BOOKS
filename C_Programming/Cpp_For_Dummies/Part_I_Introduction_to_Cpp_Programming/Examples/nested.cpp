// NestedDemo - input a series of numbers. Continue to accumulate the sum of these numbers until the user enters a 0.
...
int main(int nNumberofArgs, char* pszArgs[])
{
    ...
    cout << "This program sums multiple series\n" 
         << "of numbers. Terminate ech sequence\n"
    ...
    do
    {
        ...
        // ...and start over with a new sequence if the accumulated sequence was not zero
    }while(accumulator != 0);
