...
// square - returns the square of its argument doubleVar - the value to be squared returns - sqaure of doubleVar
double square(double doubleVar)
{
    return doubleVar * doubleVar;
}
// sumSequence - accumulate the square of the number entered at the keyboard into a sequence until the user enters a negative number
