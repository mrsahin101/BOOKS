// ArrayDemo - demonstrate the use of arrays by reading a sequence of integers and then displaying them in order
...
// displayArray - display the members of an array of length sizeOfloat
