...
BaseType_t xErrorStatus = pdPASS;
/* USER CODE END PV */
...
BaseType_t CheckTasksAreRunningWithoutError()
{
...
int main(void)
{
  ...
  MX_USART2_UART_Init();
  /* USER CODE BEGIN 2 */
  xAutoReloadTimer = xTimerCreate("AutoReload", xHealthyTimerPeriod, pdTRUE, 0, prvCheckTimerCallbackFunction);
