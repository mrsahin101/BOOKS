...
#define RAM1_SIZE 				( 1 * 256 )

#define RAM2_START_ADDRESS		( ( uint8_t * ) 0x10001000 )
#define RAM2_SIZE 				( 1 * 1024 )

#define RAM3_START_ADDRESS 		( ( uint8_t * ) 0x10002000 )
...
/* USER CODE BEGIN PV */
static uint8_t ucHeap[RAM1_SIZE] = {0x00};
...
// or for specific adress uint8_t ucHeap[ configTOTAL_HEAP_SIZE ] @ 0x20000000;
